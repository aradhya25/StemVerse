        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-6 text-center lg:text-left space-y-8 max-w-2xl mx-auto lg:mx-0">
            ...
            <div className="flex flex-col sm:flex-row justify-center lg:justify-start items-center gap-4">
              <Link
                to="/register"
                className="group inline-flex w-full sm:w-auto items-center justify-center rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 px-8 py-4 text-base font-semibold text-white shadow-lg transition-all duration-300 hover:from-blue-700 hover:to-indigo-700 hover:shadow-blue-300/40 hover:scale-105 active:scale-95"
              >
          ...
          <div className="lg:col-span-6 relative w-full max-w-xl lg:max-w-none mx-auto">
                ...
                <div className="hidden absolute inset-0 flex-col items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 p-6 space-y-6 text-center">
                  ...
                  <div className="p-4 bg-white rounded-2xl shadow-xl w-3/4 max-w-sm border border-slate-100 relative group transition-transform duration-500 hover:scale-105">
                    <div className="flex items-start space-x-3 text-left">
                      ...
                      <div className="space-y-1">
                        <h4 className="text-sm font-bold text-darkGray">
                          AI Quiz Generator
                        </h4>
                        <p className="text-xs text-darkGray-light">
                          Generating custom physics quiz based on your study
                          pattern...
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="flex space-x-4 w-full max-w-md justify-center">
                    <div className="bg-white/90 backdrop-blur p-3.5 rounded-xl shadow-lg border border-white/40 text-center flex-1">
                      ...
                      <p className="text-[10px] uppercase font-bold text-darkGray-light tracking-wider">
                        Completion Rate
                      </p>
                    </div>
                    <div className="bg-white/90 backdrop-blur p-3.5 rounded-xl shadow-lg border border-white/40 text-center flex-1">
            ...
            <div
              className="absolute -top-6 -left-6 bg-white p-3.5 rounded-xl shadow-xl border border-slate-100 hidden sm:flex items-center space-x-3 animate-bounce"
            ...
            <div className="absolute -bottom-6 -right-6 bg-white p-3.5 rounded-xl shadow-xl border border-slate-100 hidden sm:flex items-center space-x-3">
              <div className="flex -space-x-2">
                <div className="w-7 h-7 rounded-full bg-blue-500 border-2 border-white flex items-center justify-center text-[10px] text-white font-bold">
                  A
                </div>
                <div className="w-7 h-7 rounded-full bg-green-500 border-2 border-white flex items-center justify-center text-[10px] text-white font-bold">
                  B
                </div>
                <div className="w-7 h-7 rounded-full bg-amber-500 border-2 border-white flex items-center justify-center text-[10px] text-white font-bold">
                  C
                </div>
              </div>
              <div>
