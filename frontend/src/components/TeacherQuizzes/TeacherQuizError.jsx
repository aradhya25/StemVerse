...
export default function TeacherQuizError({ onRetry }) {
  return (
    <div className="bg-white rounded-3xl p-12 border border-slate-100 shadow-premium text-center space-y-6 max-w-md mx-auto animate-fadeIn">
      ...
      <div className="space-y-2">
        ...
        <p className="text-xs text-slate-400 font-normal leading-relaxed">
          Something went wrong while fetching quizzes for this lesson. Please check your connection and try again.
        </p>
      </div>
